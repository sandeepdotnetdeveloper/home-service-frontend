...
export default function providerVerifyOTP() {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  async function verifyOtp(data) {
    ...
    try {
        ...
        const url = Server_URL + "provider/verifyotp"
          ...
          if(error){
              ...
              if (message === 'OTP expired') {
                ...
                navigate("/provider/forgotpassword"); // Replace with your actual path
            }
            else{
              showErrorToast(message);
            }
              ...
              navigate("/provider/forgotpassword/updatepassword")
          }
